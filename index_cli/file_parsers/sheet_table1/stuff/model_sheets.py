...
class Sheet(Base):            # rev. 20180605
    ...
    seq = Column(Integer, nullable=False, server_default='0')       # Номер листа в файле
    ncols = Column(Integer, nullable=False, server_default='0')     # Кол-во колонок в листе
    nrows = Column(Integer, nullable=False, server_default='0')     # Кол-во строк в листе
    visible = Column(Integer, nullable=False, server_default='0')   # Видимость листа
...
#     type = Column(Integer, nullable=False, server_default='0')    # Тип ячейки
#     col = Column(Integer, nullable=False, server_default='0')     # Колонка
#     row = Column(Integer, nullable=False, server_default='0')     # Ряд
#
# #   def __init__(self, **kargs):
# #       kargs_reg = {key: value for key, value in kargs.items() if hasattr(self, key)}
# #       Base.__init__(self, **kargs_reg)
